...
def generate_launch_description():
    ...
    interface_dir = get_package_share_directory(pkg_name)
    ...
    declare_model_file_cmd = DeclareLaunchArgument(
        'model_file',
        default_value=os.path.join(interface_dir, "pddl", "assignment2_domain.pddl"),
        description='PDDL Model file'
    )

    declare_problem_file_cmd = DeclareLaunchArgument(
        'problem_file', 
        default_value=os.path.join(interface_dir, "pddl", "assignment2_problem.pddl"),
